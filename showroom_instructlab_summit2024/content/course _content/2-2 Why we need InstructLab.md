...
# We need InstructLab to help:
    
- ## keep our LLMs fresh and up todate
- ## to 'tweek' models to enhance elements of their knowledge
- ## to update rather than augment with RAG
- ## a simplified means add data without complex and highly skilled Fine-tuning 
- ## to train generic small models in the area of expertise relevant to their business applicaiton
...
In his article [What is InstructLab and why do developers need it](https://developer.ibm.com/profiles/syedame1/)
