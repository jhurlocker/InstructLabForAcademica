...
It helps you identify where knowledge should go, identify gaps in training data, and is customisable. Knowledge is added to the lowest level of the taxonomy, to the **leaf nodes**.
...
You can create private taxonomies in a structure that fits with the organisations own ontology - the taxonomy is flexible below where you split the tree for Knowledge and Skills. 
