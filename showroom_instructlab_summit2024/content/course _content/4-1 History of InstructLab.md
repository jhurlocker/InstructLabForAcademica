...
![Histroy of Instructlab](images/history.png)

---

The Instruct Lab Technique was developed by the team at Cambridge AI Model Research in the fall of 2023. Dario Gill, Head of IBM Research, quickly recognized the potential of this innovative methodology for tuning large language models through a community-driven approach. Enthusiastic about its possibilities, Dario presented the technique to Arvin and his senior leadership team on February 16th of this year. The response was overwhelmingly positive, with excitement about how Instruct Lab could enhance both IBM models and the broader open models ecosystem.
...
Today InstructLab is available as an Open Source offering for all to use to add/tune to their own model or the community model.  Or for individuals to contiribute to the development of InstructLab.