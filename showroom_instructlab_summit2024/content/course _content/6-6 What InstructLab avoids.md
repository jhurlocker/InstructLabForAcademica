...
## **Cost** 
On average organisations can make between an average or 76% to 98%* cost savings without sacrificing performance using IBM Granite models and InstructLab. The compact, CPU-optimized models are perfect for low-computing tasks and maximum return on investment.  This comparison was against such models as GTP-4 Turbo ($14 per M tokens), Lama-37B ($0.98/M tokens) Lama 3.1 405B ($5.8/M tokens) and Granite (as the SLM) being ($0.21$/M tokens)
